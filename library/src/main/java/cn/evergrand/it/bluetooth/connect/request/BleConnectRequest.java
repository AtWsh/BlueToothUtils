...
public class BleConnectRequest extends BleRequest implements ServiceDiscoverListener {
    ...
    public BleConnectRequest(ConnectOptions options, BleGeneralResponse response) {
        super(response);
        this.mConnectOptions = options != null ? options : new ConnectOptions.Builder().build();
    }
    ...
    private void onConnectSuccess() {
        ...
        if (profile != null) {
            putParcelable(BlueToothConstants.EXTRA_GATT_PROFILE, profile);
        }
