...
public class BlueToothConstants {
    ...
    public static final String EXTRA_WRITE_RES= "extra.write.res"; //写入特征值回调
    ...
    public static String getStatusText(int status) {
        switch (status) {
            case BlueToothConstants.STATUS_DEVICE_CONNECTED: return "Connected";
            case BlueToothConstants.STATUS_DEVICE_CONNECTING: return "Connecting";
            case BlueToothConstants.STATUS_DEVICE_DISCONNECTING: return "Disconnecting";
            case BlueToothConstants.STATUS_DEVICE_DISCONNECTED: return "Disconnected";
            case BlueToothConstants.STATUS_DEVICE_SERVICE_READY: return "Service Ready";
     ...
     * 操作次数和时长
     */
    public static final int BLE_SEARCH_DURATION = 8000; //默认BLE搜索时长
    public static final int CLASS_SEARCH_DURATION = 5000; //默认class搜索时长
    public static final int BLE_SEARCH_TIMES = 2; //默认搜索BLE次数
    public static final int BLE_CONNECT_RETRY = 2; //默认BLE连接重试次数
    public static final int BLE_CONNECT_TIMEOUT = 10000; //默认BLE连接超时时长
    public static final int BLE_SERVICE_DISRETRY = 2; //默认Service搜索重试次数
    public static final int BLE_SERVICE_DISTIMEOUT = 10000;//默认Service搜索超时时长
}
