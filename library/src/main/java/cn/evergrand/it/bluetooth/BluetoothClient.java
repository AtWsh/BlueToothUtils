...
class BluetoothClient implements IBluetoothClient {
    ...
    public void connectBle(String mac, ConnectResponse response) {
        connect(mac, null, response);
    }

    @Override
    public void connect(String mac, ConnectOptions options, ConnectResponse response) {
